...
ALTER TABLE "brand_kits" ALTER COLUMN "created_at" SET DEFAULT now();--> statement-breakpoint
ALTER TABLE "brand_kits" ALTER COLUMN "updated_at" SET DEFAULT now();--> statement-breakpoint
